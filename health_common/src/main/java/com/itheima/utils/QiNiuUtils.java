...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "CwDPnbqUOf3_Hy_mh6l6SRbDQ-PkvOLUoImTnM-i";
    private static final String SECRETKEY = "oEcxujT6Zh1X-_o5yrsl8RQZ7ZwnKxdfUy6h4VCI";
    private static final String BUCKET = "lj98";
    public static final String DOMAIN= "http://qfiw6hpxu.hn-bkt.clouddn.com/";
