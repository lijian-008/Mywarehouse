...
public interface MessageConstant {
    ...
    static final String DELETE_CHECKGROUP_SUCCESSS = "删除套餐成功";
    static final String DELETE_CHECKGROUP_SUCCESSSe = "编辑套餐成功";
    static final String QUERY_CHECKGROUP_SUCCESS = "查询检查组成功";
    static final String QUERY_CHECKGROUP_FAIL = "查询检查组失败";
    static final String QUERY_CHECKGROUP_FAILL = "检查组回显成功";
    ...
    static final String VALIDATECODE_ERRORA = "请重新获取验证码";
    static final String VALIDATECODE = "验证码已存在，注意查收";
